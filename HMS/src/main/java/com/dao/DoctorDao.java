	...
	public List<Doctor> getAllDoctor()
	{
		...
		try {
			...
			while(re.next())
			{
				d=new Doctor();
				d.setId(re.getInt(1));
				d.setFullName(re.getString(2));
				d.setDob(re.getString(3));
				d.setQualification(re.getString(4));
				d.setSpecialist(re.getString(5));
				d.setEmail(re.getString(6));
				d.setMobNo(re.getString(7));
				d.setPassword(re.getString(8));
				list.add(d);
			}
